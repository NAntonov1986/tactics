/* ai.js — искусственный интеллект монстров.
   Что внутри:
     ...
     • AI_POLICIES — реестр всех ИИ-политик. Сейчас единственная — zombie.
       Каждая политика — функция (unit) → последовательность setTimeout-шагов
       (атака, движение, ещё атака, конец хода) с одинаковой задержкой.
